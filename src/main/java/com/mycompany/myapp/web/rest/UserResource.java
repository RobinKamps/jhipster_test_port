...
public class UserResource {
    ...
    public ResponseEntity<User> createUser(@Valid @RequestBody UserDTO userDTO) throws URISyntaxException {
        ...
        if (userDTO.getId() != null) {
            ...
            return ResponseEntity.created(new URI("/api/users/" + newUser.getId()))
                .headers(HeaderUtil.createAlert("userManagement.created", newUser.getId().toString()))
                .body(newUser);
        }
    }
    ...
    public ResponseEntity<UserDTO> updateUser(@Valid @RequestBody UserDTO userDTO) {
        ...
        existingUser.ifPresent(userDTO1 -> log.debug("##################" + userDTO1));

        Optional<UserDTO> updatedUser = userService.updateUser(userDTO);

        updatedUser.ifPresent(userDTO1 -> log.debug("##################" + userDTO1));

        return ResponseUtil.wrapOrNotFound(updatedUser,
            HeaderUtil.createAlert("userManagement.updated", userDTO.getId().toString()));
    }
